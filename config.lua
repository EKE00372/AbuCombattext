...
-- xCT outgoing damage/healing options
	damage = true,						-- show outgoing damage in it's own frame 輸出傷害
	healing = true,						-- show outgoing healing in it's own frame輸出治療
	...
	iconswings = true,					-- show outgoing damage icons for weapon swings (white attacks)
	...
	healtreshold = 100,					-- minimum healing to show in incoming/outgoing healing messages.

-- appearence
	font = GameFontNormal:GetFont(),		    	-- "Fonts\\ARIALN.ttf" is default WoW font.
	...
	damagefont = "Interface\\AddOns\\AbuCombattext\\DIEDIEDI.ttf",	-- "Fonts\\FRIZQT__.ttf" is default WoW damage font
	damagefontsize = "20",				-- size of xCT damage font. use "auto" to set it automatically depending on icon size, or use own value, 16 for example. if it's set to number value icons will change size.
...
-- class modules and goodies
	...
	mergetime = 1,					-- Time in seconds between each output
...
-- fine tune loot options
	...
	itemsquality    = 4,     			-- filter items shown by item quality: 0 = Poor, 1 = Common, 2 = Uncommon, 3 = Rare, 4 = Epic, 5 = Legendary, 6 = Artifact, 7 = Heirloom
